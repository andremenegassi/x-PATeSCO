...
namespace UnitTestProject.F2
{
    ...
    public class F2CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void ddlstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='Alabama' or @value='Alabama']", @"//*/android.widget.Spinner[@content-desc='Alabama']", @"//*[@resource-id='search_state']", @"//*[@resource-id='searchView']//*[@content-desc='Alabama']", @"//*[@resource-id='searchView']/*[1]/*[3]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.Spinner"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc='Alabama' or @value='Alabama']", @"//*/UIAElement[@value='Alabama']", @"", @"//*[@label='Fresh-Food-Finder']//*[@value='Alabama']", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[4]", @"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIAElement"};
        ...
        public void selstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Alaska' or @label='Alaska']", @"//*/android.widget.CheckedTextView[@text='Alaska']", @"//*[@resource-id='android:id/text1']", @"//*[@resource-id='android:id/custom']//*[@text='Alaska']", @"//*[@resource-id='android:id/custom']/*[1]/*[2]", @"hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[2]"};
            ...
            {
                selectors = new string[] {@"//*[@text='Alaska' or @label='Alaska']", @"//*/UIAStaticText[@label='Alaska']", @"//*[@name='Alaska']", @"//*[@name='Alaska']//*[@label='Alaska']", @"//*[@name='Alaska']/*[1]", @"AppiumAUT/UIAApplication/UIAWindow/UIAPopover/UIATableView/UIATableCell[2]/UIAStaticText"};
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"", @"//*/android.widget.EditText[@resource-id='search_searchPhrase']", @"//*[@resource-id='search_searchPhrase']", @"//*[@resource-id='searchView']//*[@resource-id='search_searchPhrase']", @"//*[@resource-id='searchView']/*[4]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.EditText"};
            ...
            {
                selectors = new string[] {@"", @"", @"", @"//*[@label='Fresh-Food-Finder']//*[]", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[6]", @"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIATextField"};
        ...
        public void tpproductSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@content-desc='Baked Goods' or @label='Baked Goods']", @"//*/UIAStaticText[@label='Baked Goods']", @"//*[@name='Baked Goods']", @"//*[@label='Fresh-Food-Finder']//*[@label='Baked Goods']", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[11]", @"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIAStaticText[7]"};
        ...
        public void btnsearch2SendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@content-desc='Search' or @label='Search']", @"//*/UIALink[@label='Search']", @"//*[@name='Search']", @"//*[@label='Fresh-Food-Finder']//*[@label='Search']", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[51]", @"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIALink[2]"};
...
9758 Hwy 25, Calera, Al 35040
Calera, Alabama, 35040']", @"//*[@resource-id='searchResultsView']/*[2]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.ListView/android.view.View"};
            ...
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@content-desc='Calera Farmers Market
9758 Hwy 25, Calera, Al 35040
Calera, Alabama, 35040' or @label='Calera Farmers Market']", @"//*/UIAStaticText[@label='Calera Farmers Market']", @"//*[@name='Calera Farmers Market']", @"//*[@label='Fresh-Food-Finder']//*[@label='Calera Farmers Market']", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[6]", @"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIAStaticText[6]"};
