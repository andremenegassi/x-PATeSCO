...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnsearchSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc='Search For a Market']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Search For a Market']"};
        ...
        public void ddlstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Spinner[@content-desc='Alabama']"};
            ...
            {
                selectors = new string[] {@"//*/UIAElement[@value='Alabama']"};
        ...
        public void selstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.CheckedTextView[@text='Alaska']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Alaska']"};
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.EditText[@resource-id='search_searchPhrase']"};
        ...
        public void tpproductSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.CheckBox[@content-desc='Baked Goods']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Baked Goods']"};
        ...
        public void tppaymentSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.CheckBox[@content-desc='Credit Cards Accepted']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Credit Cards Accepted']"};
        ...
        public void btnsearch2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc='Search']"};
            ...
            {
                selectors = new string[] {@"//*/UIALink[@label='Search']"};
        ...
        public void mktSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc='Calera Farmers Market
...
Calera, Alabama, 35040']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Calera Farmers Market']"};
