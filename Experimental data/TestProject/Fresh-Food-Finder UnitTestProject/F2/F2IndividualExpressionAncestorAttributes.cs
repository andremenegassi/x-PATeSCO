...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorAttributes
    {
        ...
        public void btnsearchSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='defaultView']//*[@content-desc='Search For a Market']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Search For a Market']//*[@label='Search For a Market']"};
        ...
        public void ddlstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']//*[@content-desc='Alabama']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[@value='Alabama']"};
        ...
        public void selstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/custom']//*[@text='Alaska']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Alaska']//*[@label='Alaska']"};
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']//*[@resource-id='search_searchPhrase']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[]"};
        ...
        public void tpproductSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']//*[@content-desc='Baked Goods']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[@label='Baked Goods']"};
        ...
        public void tppaymentSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']//*[@content-desc='Credit Cards Accepted']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[@label='Credit Cards Accepted']"};
        ...
        public void btnsearch2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']//*[@content-desc='Search']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[@label='Search']"};
        ...
        public void mktSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchResultsView']//*[@content-desc='Calera Farmers Market
...
Calera, Alabama, 35040']"};
            ...
            {
                selectors = new string[] {@"//*[@label='Fresh-Food-Finder']//*[@label='Calera Farmers Market']"};
