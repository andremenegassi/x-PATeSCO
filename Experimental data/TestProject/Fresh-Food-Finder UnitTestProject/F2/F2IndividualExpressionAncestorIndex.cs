...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchView']/*[4]"};
