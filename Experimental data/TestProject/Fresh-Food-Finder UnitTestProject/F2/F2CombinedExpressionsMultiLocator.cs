...
namespace UnitTestProject.F2
{
    ...
    public class F2CombinedExpressionsMultiLocator
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"CombinedExpressionsMultiLocator", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void ddlstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.Spinner", @"//*[@resource-id='search_state']", @"//*[@content-desc='Alabama' or @value='Alabama']", @"//*/android.widget.Spinner[@content-desc='Alabama']", @"//*[@resource-id='searchView']/*[1]/*[3]", @"//*[@resource-id='searchView']//*[@content-desc='Alabama']"};
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIAElement", @"", @"//*[@content-desc='Alabama' or @value='Alabama']", @"//*/UIAElement[@value='Alabama']", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[4]", @"//*[@label='Fresh-Food-Finder']//*[@value='Alabama']"};
        ...
        public void selstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[2]", @"//*[@resource-id='android:id/text1']", @"//*[@text='Alaska' or @label='Alaska']", @"//*/android.widget.CheckedTextView[@text='Alaska']", @"//*[@resource-id='android:id/custom']/*[1]/*[2]", @"//*[@resource-id='android:id/custom']//*[@text='Alaska']"};
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAPopover/UIATableView/UIATableCell[2]/UIAStaticText", @"//*[@name='Alaska']", @"//*[@text='Alaska' or @label='Alaska']", @"//*/UIAStaticText[@label='Alaska']", @"//*[@name='Alaska']/*[1]", @"//*[@name='Alaska']//*[@label='Alaska']"};
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.EditText", @"//*[@resource-id='search_searchPhrase']", @"", @"//*/android.widget.EditText[@resource-id='search_searchPhrase']", @"//*[@resource-id='searchView']/*[4]", @"//*[@resource-id='searchView']//*[@resource-id='search_searchPhrase']"};
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAWebView/UIATextField", @"", @"", @"", @"//*[@label='Fresh-Food-Finder']/*[1]/*[1]/*[1]/*[6]", @"//*[@label='Fresh-Food-Finder']//*[]"};
