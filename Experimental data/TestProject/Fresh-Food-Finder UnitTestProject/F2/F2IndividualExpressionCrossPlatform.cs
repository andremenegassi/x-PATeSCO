...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selstateSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@text='Alaska' or @label='Alaska']"};
                contingencyXPathSelector = "AppiumAUT/UIAApplication/UIAWindow/UIAPopover/UIATableView/UIATableCell[2]";
            }
