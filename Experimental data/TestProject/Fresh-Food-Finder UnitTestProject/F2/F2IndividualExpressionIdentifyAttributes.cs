...
namespace UnitTestProject.F2
{
    ...
    [TestClass]
    public class F2IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("FFF", ProjectConfig.OutputDeviceID, "F2", 8,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnsearchSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='search']"};
        ...
        public void ddlstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='search_state']"};
        ...
        public void selstateSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/text1']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Alaska']"};
        ...
        public void citySendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='search_searchPhrase']"};
        ...
        public void tpproductSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='search_bakedGoods']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Baked Goods']"};
        ...
        public void tppaymentSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='search_credit']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Credit Cards Accepted']"};
        ...
        public void btnsearch2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='searchButton']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Search']"};
        ...
        public void mktSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Calera Farmers Market']"};
