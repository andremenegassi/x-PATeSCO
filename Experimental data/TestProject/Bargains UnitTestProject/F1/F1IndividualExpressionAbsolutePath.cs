...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionAbsolutePath
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Ofertados", ProjectConfig.OutputDeviceID, "F1", 6,"IndividualExpressionAbsolutePath", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirdescricaoSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATableView/UIATableCell[2]/UIATextField"};
        ...
        public void inserirprecoantigoSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATableView/UIATableCell[3]/UIATextField"};
        ...
        public void inserirpreconovoSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATableView/UIATableCell[4]/UIATextField"};
        ...
        public void btnsalvarSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIANavigationBar/UIAButton[3]"};
