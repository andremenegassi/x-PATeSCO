...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAbsolutePath
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Ofertados", ProjectConfig.OutputDeviceID, "F2", 4,"IndividualExpressionAbsolutePath", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnselSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATableView/UIATableCell[2]/UIAButton/UIAStaticText"};
