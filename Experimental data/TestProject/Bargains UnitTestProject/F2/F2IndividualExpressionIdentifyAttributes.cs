...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Ofertados", ProjectConfig.OutputDeviceID, "F2", 4,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnselSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Teste Empresa']"};
