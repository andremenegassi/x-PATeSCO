...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F2", 2,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void tocarForaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='CordovaToDoApp_AngularJS']/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='AngularJSTodoApp']/*[1]/*[1]/*[1]/*[1]/*[1]/*[1]"};
