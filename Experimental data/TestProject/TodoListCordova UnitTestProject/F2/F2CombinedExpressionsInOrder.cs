...
namespace UnitTestProject.F2
{
    ...
    public class F2CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F2", 2,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void alterarTextoSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Tarefa1' or @value='Tarefa1']", @"//*/android.widget.EditText[@text='Tarefa1']", @"", @"//*[@resource-id='todo-list']//*[@text='Tarefa1']", @"//*[@resource-id='todo-list']/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.EditText"};
            ...
            {
                selectors = new string[] {@"//*[@text='Tarefa1' or @value='Tarefa1']", @"//*/XCUIElementTypeTextField[@value='Tarefa1']", @"", @"//*[@label='region']//*[@value='Tarefa1']", @"//*[@label='region']/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeTextField"};
        ...
        public void tocarForaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@label='CordovaToDoApp_AngularJS']", @"//*/android.view.View[@resource-id='todoapp']", @"//*[@resource-id='todoapp']", @"//*[@content-desc='CordovaToDoApp_AngularJS']//*[@resource-id='todoapp']", @"//*[@content-desc='CordovaToDoApp_AngularJS']/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View"};
            ...
            {
                selectors = new string[] {@"//*[@label='CordovaToDoApp_AngularJS']", @"//*/XCUIElementTypeOther[@label='CordovaToDoApp_AngularJS']", @"//*[@name='CordovaToDoApp_AngularJS']", @"//*[@label='AngularJSTodoApp']//*[@label='CordovaToDoApp_AngularJS']", @"//*[@label='AngularJSTodoApp']/*[1]/*[1]/*[1]/*[1]/*[1]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther"};
