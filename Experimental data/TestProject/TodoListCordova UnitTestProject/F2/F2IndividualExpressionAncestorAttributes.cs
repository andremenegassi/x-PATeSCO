...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F2", 2,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void alterarTextoSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@label='region']//*[@value='Tarefa1']"};
        ...
        public void tocarForaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='CordovaToDoApp_AngularJS']//*[@resource-id='todoapp']"};
            ...
            {
                selectors = new string[] {@"//*[@label='AngularJSTodoApp']//*[@label='CordovaToDoApp_AngularJS']"};
