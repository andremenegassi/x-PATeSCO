...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeTextField[@value='Tarefa1a']"};
