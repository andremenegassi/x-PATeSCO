...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirTextoSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@resource-id='header']//*[@text='What needs to be done?']" };
            ...
            {
                selectors = new string[] { @"//*[@label='region']//*[@value='What needs to be done?']" };
        ...
        public void btnAdicionarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@resource-id='header']//*[@content-desc='+']" };
            ...
            {
                selectors = new string[] { @"//*[@label='region']//*[@label='+']" };
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='todo-list']//*[@text='Tarefa1']"};
            ...
            {
                selectors = new string[] {@"//*[@label='region']//*[@value='Tarefa1a']"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='todo-list']//*[]"};
            ...
            {
                selectors = new string[] {@"//*[@label='region']//*[]"};
