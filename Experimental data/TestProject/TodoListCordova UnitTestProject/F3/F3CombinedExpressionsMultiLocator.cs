...
namespace UnitTestProject.F3
{
    ...
    public class F3CombinedExpressionsMultiLocator
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"CombinedExpressionsMultiLocator", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.EditText", @"", @"//*[@text='Tarefa1' or @value='Tarefa1a']", @"//*/android.widget.EditText[@text='Tarefa1']", @"//*[@resource-id='todo-list']/*[1]/*[1]", @"//*[@resource-id='todo-list']//*[@text='Tarefa1']"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.Button", @"", @"", @"", @"//*[@resource-id='todo-list']/*[1]/*[3]", @"//*[@resource-id='todo-list']//*[]"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeButton", @"", @"", @"", @"//*[@label='region']/*[3]", @"//*[@label='region']//*[]"};
