...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirTextoSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@resource-id='header']/*[2]" };
            ...
            {
                selectors = new string[] { @"//*[@label='region']/*[1]/*[1]" };
        ...
        public void btnAdicionarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@resource-id='header']/*[3]" };
            ...
            {
                selectors = new string[] { @"//*[@label='region']/*[1]/*[2]" };
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='todo-list']/*[1]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='region']/*[1]"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='todo-list']/*[1]/*[3]"};
            ...
            {
                selectors = new string[] {@"//*[@label='region']/*[3]"};
