...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirTextoSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@text='What needs to be done?' or @value='What needs to be done?']" };
        ...
        public void btnAdicionarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] { @"//*[@content-desc='+' or @label='+']" };
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Tarefa1' or @value='Tarefa1a']"};
