...
namespace UnitTestProject.F3
{
    ...
    public class F3CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoListCordova", ProjectConfig.OutputDeviceID, "F3", 2,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selTarefaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Tarefa1' or @value='Tarefa1a']", @"//*/android.widget.EditText[@text='Tarefa1']", @"", @"//*[@resource-id='todo-list']//*[@text='Tarefa1']", @"//*[@resource-id='todo-list']/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.EditText"};
            ...
            {
                selectors = new string[] {@"//*[@text='Tarefa1' or @value='Tarefa1a']", @"//*/XCUIElementTypeTextField[@value='Tarefa1a']", @"", @"//*[@label='region']//*[@value='Tarefa1a']", @"//*[@label='region']/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeTextField"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"", @"", @"", @"//*[@resource-id='todo-list']//*[]", @"//*[@resource-id='todo-list']/*[1]/*[3]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.Button"};
            ...
            {
                selectors = new string[] {@"", @"", @"", @"//*[@label='region']//*[]", @"//*[@label='region']/*[3]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeButton"};
