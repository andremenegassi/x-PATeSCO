...
namespace UnitTestProject
{
    public static class ProjectConfig
    {
        ...
        static ProjectConfig()
        {
            ...
            var configs = new[]{
                new { OutputDeviceID = "Android6.0.1-MotoG4", PlataformName = "Android", PlatformVersion = "6.0.1", DeviceName = "0027098861", AppPackage = "com.todo", Uuid = "", AppPath = @"", AppActivity = @"com.todo.MainActivity" },
                new { OutputDeviceID = "Android5.1-MotoG1", PlataformName = "Android", PlatformVersion = "5.1", DeviceName = "T0997063PS", AppPackage = "com.todo", Uuid = "", AppPath = @"", AppActivity = @"com.todo.MainActivity"},
                new { OutputDeviceID = "IOS9.3-iPad", PlataformName = "iOS", PlatformVersion = "7.3", DeviceName = "iPadWeb", AppPackage = "org.reactjs.native.example.todo", Uuid = "b35c1fcf89f97266dac59d48037b52dfabe5fccb", AppPath = @"", AppActivity = @""},
                new { OutputDeviceID = "IOS7.1.2-iPhone", PlataformName = "iOS", PlatformVersion = "7.1.2", DeviceName = "iPhoneAndre", AppPackage = "org.reactjs.native.example.todo", Uuid = "e5da05bf8763bbd6e853205b6e57a89af0ee8c4d", AppPath = @"", AppActivity = @""},
                new { OutputDeviceID = "IOS10.2-iPad4", PlataformName = "iOS", PlatformVersion = "10.2", DeviceName = "iPad4", AppPackage = "org.reactjs.native.example.todo", Uuid = "3b5a62f85e1d2b47237b79b12fb3f42490f8d1e7", AppPath = @"", AppActivity = ""},
                new { OutputDeviceID = "Android4.4-TabletSamsung", PlataformName = "Android", PlatformVersion = "4.4", DeviceName = "3004d2af55e18200", AppPackage = "com.todo", Uuid = "", AppPath = @"C:\Users\André\OneDrive\Documentos\Mestrado\Dissertação\Experimento\Recursos\Apps\ReactNative\TodoList\app-debug.apk",  AppActivity = @"com.todo.MainActivity"}
