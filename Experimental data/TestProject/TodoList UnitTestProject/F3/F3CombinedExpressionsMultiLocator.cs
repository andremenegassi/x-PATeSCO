...
namespace UnitTestProject.F3
{
    ...
    public class F3CombinedExpressionsMultiLocator
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"CombinedExpressionsMultiLocator", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.support.v7.widget.LinearLayoutCompat/android.widget.TextView", @"", @"//*[@content-desc='Todo' or @label='Recents']", @"//*/android.widget.TextView[@content-desc='Todo']", @"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[2]/*[1]", @"//*[@resource-id='android:id/content']//*[@content-desc='Todo']"};
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATabBar/UIAButton", @"//*[@name='Recents']", @"//*[@content-desc='Todo' or @label='Recents']", @"//*/UIAButton[@label='Recents']", @"//*[@label='todo']/*[1]/*[3]/*[3]", @"//*[@label='todo']//*[@label='Recents']"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.support.v4.view.ViewPager/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView", @"", @"//*[@text='Done' or @label=' Done']", @"//*/android.widget.TextView[@text='Done']", @"//*[@resource-id='android:id/content']/*[1]/*[1]/*[2]/*[1]/*[1]/*[2]/*[1]/*[2]/*[1]", @"//*[@resource-id='android:id/content']//*[@text='Done']"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.support.v4.view.ViewPager/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView/UIAElement", @"//*[@name=' Done']", @"//*[@text='Done' or @label=' Done']", @"//*/UIAElement[@label=' Done']", @"//*[@label='todo']/*[1]/*[2]/*[3]", @"//*[@label='todo']//*[@label=' Done']"};
