...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnnovoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[1]/*[2]"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']/*[1]/*[4]/*[4]"};
        ...
        public void inserirtarefaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[1]/*[2]/*[1]/*[1]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']/*[1]/*[1]"};
        ...
        public void btnaddSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[1]/*[2]/*[1]/*[1]/*[2]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']/*[1]/*[2]"};
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[2]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']/*[1]/*[3]/*[3]"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[1]/*[2]/*[1]/*[1]/*[2]/*[1]/*[2]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']/*[1]/*[2]/*[3]"};
