...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnnovoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='Add' or @label='More']"};
        ...
        public void inserirtarefaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Todo' or @value='Todo']"};
        ...
        public void btnaddSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Add Todo' or @label=' Add Todo']"};
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='Todo' or @label='Recents']"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Done' or @label=' Done']"};
