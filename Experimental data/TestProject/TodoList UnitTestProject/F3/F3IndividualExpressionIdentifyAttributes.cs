...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnnovoSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='More']"};
        ...
        public void btnaddSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name=' Add Todo']"};
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Recents']"};
