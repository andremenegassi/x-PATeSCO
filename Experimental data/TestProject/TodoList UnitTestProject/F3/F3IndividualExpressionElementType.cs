...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.TextView[@content-desc='Todo']"};
            ...
            {
                selectors = new string[] {@"//*/UIAButton[@label='Recents']"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.TextView[@text='Done']"};
            ...
            {
                selectors = new string[] {@"//*/UIAElement[@label=' Done']"};
