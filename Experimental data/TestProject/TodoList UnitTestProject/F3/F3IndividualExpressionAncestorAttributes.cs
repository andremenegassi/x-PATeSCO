...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("TodoList", ProjectConfig.OutputDeviceID, "F3", 5,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnnovoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='Add']"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']//*[@label='More']"};
        ...
        public void inserirtarefaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@text='Todo']"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']//*[@value='Todo']"};
        ...
        public void btnaddSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@text='Add Todo']"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']//*[@label=' Add Todo']"};
        ...
        public void btnvoltarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='Todo']"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']//*[@label='Recents']"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@text='Done']"};
            ...
            {
                selectors = new string[] {@"//*[@label='todo']//*[@label=' Done']"};
