...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAbsolutePath
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("MovieApp", ProjectConfig.OutputDeviceID, "F2", 5,"IndividualExpressionAbsolutePath", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnMenuSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeNavigationBar/XCUIElementTypeStaticText"};
        ...
        public void btnSearchSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeNavigationBar/XCUIElementTypeButton[2]"};
        ...
        public void btnSearchMovieSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.EditText"};
        ...
        public void btnSelMovieSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther"};
