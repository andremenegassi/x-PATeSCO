...
namespace UnitTestProject.F2
{
    ...
    public class F2CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("MovieApp", ProjectConfig.OutputDeviceID, "F2", 5,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnTrailersSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='TRAILERS' or @label='TRAILERS']", @"//*/android.view.ViewGroup[@content-desc='TRAILERS']", @"", @"//*[@resource-id='android:id/content']//*[@content-desc='TRAILERS']", @"//*[@resource-id='android:id/content']/*[1]/*[2]/*[1]/*[1]/*[1]/*[1]/*[10]/*[1]/*[4]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup[4]"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup[4]";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@content-desc='TRAILERS' or @label='TRAILERS']", @"//*/XCUIElementTypeButton[@label='TRAILERS']", @"//*[@name='TRAILERS']", @"//*[@label='INFO CASTS TRAILERS ']//*[@label='TRAILERS']", @"//*[@label='INFO CASTS TRAILERS ']/*[3]", @"[2]/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeButton[3]"};
