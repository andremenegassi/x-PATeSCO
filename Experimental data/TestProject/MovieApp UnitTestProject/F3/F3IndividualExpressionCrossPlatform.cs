...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("MovieApp", ProjectConfig.OutputDeviceID, "F3", 1,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnTopRatedSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Top Rated' or @label=' Top Rated']"};
