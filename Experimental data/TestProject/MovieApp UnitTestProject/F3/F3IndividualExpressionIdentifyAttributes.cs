...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("MovieApp", ProjectConfig.OutputDeviceID, "F3", 1,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnTopRatedSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name=' Top Rated']"};
