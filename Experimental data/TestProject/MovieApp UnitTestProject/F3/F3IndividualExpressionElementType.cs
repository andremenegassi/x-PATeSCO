...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("MovieApp", ProjectConfig.OutputDeviceID, "F3", 1,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnTopRatedSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.TextView[@text='Top Rated']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeOther[@label=' Top Rated']"};
