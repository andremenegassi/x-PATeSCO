...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F2", 4,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='Pesquisar']"};
