...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F2", 4,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnLupaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[2]/*[1]/*[3]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='banner']/*[3]/*[1]"};
        ...
        public void inserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[2]/*[1]/*[2]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='banner']/*[1]/*[2]/*[2]"};
        ...
        public void btnPesquisarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[2]/*[1]/*[3]"};
            ...
            {
                selectors = new string[] {@"//*[@label='banner']/*[1]/*[4]"};
