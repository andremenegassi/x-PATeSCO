...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F2", 4,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnLupaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']//*[@content-desc='']"};
        ...
        public void inserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']//*[@content-desc='Pesquisar']"};
            ...
            {
                selectors = new string[] {@"//*[@label='banner']//*[]"};
