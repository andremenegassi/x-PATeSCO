...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F3", 4,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnCategoriasSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc=' Categorias']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeStaticText[@label='Categorias']"};
        ...
        public void btnAnimacoesSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc=' Animações']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeStaticText[@label='Animações']"};
