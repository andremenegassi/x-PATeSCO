...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F3", 4,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnMaisTardeSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/button3']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Mais tarde']"};
        ...
        public void menuSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='MemesPlay']"};
        ...
        public void btnCategoriasSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Categorias']"};
        ...
        public void btnAnimacoesSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Animações']"};
