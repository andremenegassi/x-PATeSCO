...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F3", 4,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnCategoriasSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[1]/*[7]"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']/*[1]/*[8]/*[3]/*[1]"};
        ...
        public void btnAnimacoesSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[1]/*[9]"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']/*[1]/*[10]/*[2]/*[1]"};
