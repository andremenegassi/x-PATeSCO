...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F3", 4,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnMaisTardeSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Mais tarde' or @label='Mais tarde']"};
        ...
        public void menuSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@label='MemesPlay']"};
        ...
        public void btnCategoriasSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Categorias' or @label='Categorias']"};
        ...
        public void btnAnimacoesSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Animações' or @label='Animações']"};
