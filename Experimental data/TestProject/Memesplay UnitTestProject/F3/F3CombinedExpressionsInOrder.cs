...
namespace UnitTestProject.F3
{
    ...
    public class F3CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F3", 4,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnCategoriasSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Categorias' or @label='Categorias']", @"//*/android.view.View[@content-desc=' Categorias']", @"", @"//*[@resource-id='app']//*[@content-desc=' Categorias']", @"//*[@resource-id='app']/*[1]/*[7]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[7]"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc=' Categorias' or @label='Categorias']", @"//*/XCUIElementTypeStaticText[@label='Categorias']", @"//*[@name='Categorias']", @"//*[@label='MemesPlay']//*[@label='Categorias']", @"//*[@label='MemesPlay']/*[1]/*[8]/*[3]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[8]/XCUIElementTypeOther[2]/XCUIElementTypeStaticText"};
        ...
        public void btnAnimacoesSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Animações' or @label='Animações']", @"//*/android.view.View[@content-desc=' Animações']", @"", @"//*[@resource-id='app']//*[@content-desc=' Animações']", @"//*[@resource-id='app']/*[1]/*[9]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[9]"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc=' Animações' or @label='Animações']", @"//*/XCUIElementTypeStaticText[@label='Animações']", @"//*[@name='Animações']", @"//*[@label='MemesPlay']//*[@label='Animações']", @"//*[@label='MemesPlay']/*[1]/*[10]/*[2]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[10]/XCUIElementTypeOther[2]/XCUIElementTypeStaticText"};
