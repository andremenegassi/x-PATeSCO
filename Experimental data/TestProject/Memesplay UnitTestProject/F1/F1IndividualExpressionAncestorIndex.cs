...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnMaisTardeSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@label='Avalie o app']/*[1]/*[2]/*[1]/*[3]/*[2]/*[1]"};
        ...
        public void menuSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[2]/*[1]/*[1]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']/*[1]/*[2]/*[1]"};
        ...
        public void btnEnviarVideoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[1]/*[4]"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']/*[1]/*[5]/*[2]/*[1]"};
        ...
        public void btnEnviarVideo2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='app']/*[2]/*[3]/*[1]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']/*[2]/*[3]/*[1]/*[1]"};
