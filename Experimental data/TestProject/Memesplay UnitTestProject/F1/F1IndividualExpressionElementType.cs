...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnMaisTardeSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Button[@text='Mais tarde']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeButton[@label='Mais tarde']"};
        ...
        public void menuSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeStaticText[@label='MemesPlay']"};
        ...
        public void btnEnviarVideoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc=' Enviar Video']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeStaticText[@label='Enviar Video']"};
        ...
        public void btnEnviarVideo2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Button[@content-desc='ENVIAR VIDEO']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeButton[@label='ENVIAR VIDEO']"};
