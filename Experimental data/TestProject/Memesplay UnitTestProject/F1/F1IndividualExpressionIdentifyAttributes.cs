...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnEnviarVideoSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Enviar Video']"};
