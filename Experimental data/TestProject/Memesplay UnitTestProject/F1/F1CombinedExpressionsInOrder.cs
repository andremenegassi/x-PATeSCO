...
namespace UnitTestProject.F1
{
    ...
    public class F1CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F1", 4,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void menuSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@label='MemesPlay']", @"", @"", @"//*[@resource-id='app']//*[]", @"//*[@resource-id='app']/*[2]/*[1]/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.widget.Button"};
            ...
            {
                selectors = new string[] {@"//*[@label='MemesPlay']", @"//*/XCUIElementTypeStaticText[@label='MemesPlay']", @"//*[@name='MemesPlay']", @"//*[@label='MemesPlay']//*[@label='MemesPlay']", @"//*[@label='MemesPlay']/*[1]/*[2]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeStaticText"};
        ...
        public void btnEnviarVideoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Enviar Video' or @label='Enviar Video']", @"//*/android.view.View[@content-desc=' Enviar Video']", @"", @"//*[@resource-id='app']//*[@content-desc=' Enviar Video']", @"//*[@resource-id='app']/*[1]/*[4]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[4]"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc=' Enviar Video' or @label='Enviar Video']", @"//*/XCUIElementTypeStaticText[@label='Enviar Video']", @"//*[@name='Enviar Video']", @"//*[@label='MemesPlay']//*[@label='Enviar Video']", @"//*[@label='MemesPlay']/*[1]/*[5]/*[2]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[5]/XCUIElementTypeOther[2]/XCUIElementTypeStaticText"};
        ...
        public void btnEnviarVideo2SendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='ENVIAR VIDEO' or @label='ENVIAR VIDEO']", @"//*/android.widget.Button[@content-desc='ENVIAR VIDEO']", @"", @"//*[@resource-id='app']//*[@content-desc='ENVIAR VIDEO']", @"//*[@resource-id='app']/*[2]/*[3]/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[3]/android.view.View/android.widget.Button"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc='ENVIAR VIDEO' or @label='ENVIAR VIDEO']", @"//*/XCUIElementTypeButton[@label='ENVIAR VIDEO']", @"//*[@name='ENVIAR VIDEO']", @"//*[@label='MemesPlay']//*[@label='ENVIAR VIDEO']", @"//*[@label='MemesPlay']/*[2]/*[3]/*[1]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeButton"};
