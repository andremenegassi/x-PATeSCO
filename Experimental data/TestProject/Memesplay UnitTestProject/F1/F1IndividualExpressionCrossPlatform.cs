    ...
    public class F1IndividualExpressionCrossPlatform
    {
        ...
        public void TestMethodMain()
        {
           ...
           System.Threading.Thread.Sleep(15000);
            ...
            Exec.Create("Memesplay", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionCrossPlatform", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnEnviarVideoSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc=' Enviar Video' or @label='Enviar Video']"};
