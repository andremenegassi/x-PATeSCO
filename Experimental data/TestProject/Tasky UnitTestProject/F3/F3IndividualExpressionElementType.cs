...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F3", 3,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btndeleteSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Button[@text='Cancel']"};
            ...
            {
                selectors = new string[] {@"//*/UIAStaticText[@label='Delete']"};
