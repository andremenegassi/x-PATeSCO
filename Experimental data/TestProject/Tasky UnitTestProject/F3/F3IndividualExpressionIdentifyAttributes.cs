...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F3", 3,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btndeleteSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='com.xamarin.samples.taskyandroid:id/CancelDeleteButton']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Delete']"};
