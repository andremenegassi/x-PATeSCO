...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F3", 3,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnaddSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@text='Add Task']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Tasky']//*[@label='Add']"};
        ...
        public void inserirnomeSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@resource-id='com.xamarin.samples.taskyandroid:id/NameText']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Name']//*[@value='task name']"};
        ...
        public void btndeleteSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@text='Cancel']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Delete']//*[@label='Delete']"};
