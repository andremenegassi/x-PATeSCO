...
namespace UnitTestProject.F3
{
    ...
    public class F3IndividualExpressionAbsolutePath
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F3", 3,"IndividualExpressionAbsolutePath", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btndeleteSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.RelativeLayout/android.widget.Button[2]"};
            ...
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIATableView/UIATableCell[5]/UIAStaticText"};
