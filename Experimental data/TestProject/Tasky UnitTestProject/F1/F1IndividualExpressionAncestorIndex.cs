...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[5]"};
            ...
            {
                selectors = new string[] {@"//*[@value='0']/*[2]"};
        ...
        public void btnsaveSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']/*[1]/*[6]"};
            ...
            {
                selectors = new string[] {@"//*[@name='Save']/*[1]"};
