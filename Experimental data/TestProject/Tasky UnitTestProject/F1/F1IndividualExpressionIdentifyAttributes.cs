...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Tasky", ProjectConfig.OutputDeviceID, "F1", 4,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnaddSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='com.xamarin.samples.taskyandroid:id/AddButton']"};
        ...
        public void inserirnomeSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='com.xamarin.samples.taskyandroid:id/NameText']"};
        ...
        public void btndoneSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='com.xamarin.samples.taskyandroid:id/chkDone']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Done']"};
        ...
        public void btnsaveSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='com.xamarin.samples.taskyandroid:id/SaveButton']"};
            ...
            {
                selectors = new string[] {@"//*[@name='Save']"};
