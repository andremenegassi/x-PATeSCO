...
namespace UnitTestProject.F1
{
    ...
    public class F1CombinedExpressionsInOrder
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Agenda", ProjectConfig.OutputDeviceID, "F1", 7,"CombinedExpressionsInOrder", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnNovoRegistroSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='Novo Registro' or @label='Novo Registro']", @"//*/android.view.View[@content-desc='Novo Registro']", @"", @"//*[@content-desc='agenda']//*[@content-desc='Novo Registro']", @"//*[@content-desc='agenda']/*[1]/*[1]/*[2]/*[2]/*[2]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[2]"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc='Novo Registro' or @label='Novo Registro']", @"//*/XCUIElementTypeStaticText[@label='Novo Registro']", @"//*[@name='Novo Registro']", @"//*[@label='Novo Registro']//*[@label='Novo Registro']", @"//*[@label='Novo Registro']/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeLink[2]/XCUIElementTypeStaticText"};
        ...
        public void inserirNomeSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Nome ']", @"//*/android.widget.EditText[@text='Nome ']", @"//*[@resource-id='txtNome']", @"//*[@resource-id='pgCadastro']//*[@text='Nome ']", @"//*[@resource-id='pgCadastro']/*[1]/*[3]/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.view.View/android.widget.EditText"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.view.View/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@text='Nome ']", @"", @"", @"//*[@label='main']//*[]", @"//*[@label='main']/*[3]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[3]/XCUIElementTypeTextField"};
        ...
        public void inserirEmailSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Email ']", @"//*/android.widget.EditText[@text='Email ']", @"//*[@resource-id='txtEmail']", @"//*[@resource-id='pgCadastro']//*[@text='Email ']", @"//*[@resource-id='pgCadastro']/*[1]/*[4]/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[4]/android.view.View/android.widget.EditText"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[4]/android.view.View/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@text='Email ']", @"", @"", @"//*[@label='main']//*[]", @"//*[@label='main']/*[4]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[4]/XCUIElementTypeTextField"};
        ...
        public void inserirTelefoneSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='Telefone ']", @"//*/android.widget.EditText[@text='Telefone ']", @"//*[@resource-id='txtTelefone']", @"//*[@resource-id='pgCadastro']//*[@text='Telefone ']", @"//*[@resource-id='pgCadastro']/*[1]/*[5]/*[1]/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[5]/android.view.View/android.widget.EditText"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.view.View[5]/android.view.View/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@text='Telefone ']", @"", @"", @"//*[@label='main']//*[]", @"//*[@label='main']/*[5]/*[1]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[5]/XCUIElementTypeTextField"};
        ...
        public void btnSalvarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='save   GRAVAR ' or @label='save   GRAVAR']", @"//*/android.widget.Button[@content-desc='save   GRAVAR ']", @"//*[@resource-id='btnGravar']", @"//*[@resource-id='pgCadastro']//*[@content-desc='save   GRAVAR ']", @"//*[@resource-id='pgCadastro']/*[1]/*[8]", @"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.Button[3]"};
            ...
            {
                selectors = new string[] {@"//*[@content-desc='save   GRAVAR ' or @label='save   GRAVAR']", @"//*/XCUIElementTypeButton[@label='save   GRAVAR']", @"//*[@name='save   GRAVAR']", @"//*[@label='main']//*[@label='save   GRAVAR']", @"//*[@label='main']/*[8]", @"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeButton[3]"};
        ...
        public void btnOKSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@text='OK' or @label='OK']", @"//*/android.widget.Button[@text='OK']", @"//*[@resource-id='android:id/button1']", @"//*[@resource-id='android:id/buttonPanel']//*[@text='OK']", @"//*[@resource-id='android:id/buttonPanel']/*[1]", @"hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.Button"};
            ...
            {
                selectors = new string[] {@"//*[@text='OK' or @label='OK']", @"//*/XCUIElementTypeButton[@label='OK']", @"//*[@name='OK']", @"//*[@label='index.html']//*[@label='OK']", @"//*[@label='index.html']/*[1]/*[2]/*[1]/*[3]/*[1]/*[1]", @"XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeAlert/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeCollectionView/XCUIElementTypeCell/XCUIElementTypeButton"};
