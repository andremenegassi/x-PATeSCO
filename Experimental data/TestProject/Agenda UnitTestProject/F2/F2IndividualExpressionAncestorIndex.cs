...
namespace UnitTestProject.F2
{
    ...
    [TestClass]
    public class F2IndividualExpressionAncestorIndex
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Agenda", ProjectConfig.OutputDeviceID, "F2", 7,"IndividualExpressionAncestorIndex", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnPesquisaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@content-desc='agenda']/*[1]/*[1]/*[2]/*[2]/*[3]"};
            ...
            {
                selectors = new string[] {@"//*[@label='navigation']/*[3]"};
        ...
        public void btnInserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='pgPesquisa']/*[1]/*[1]"};
            ...
            {
                selectors = new string[] {@"//*[@label='main']/*[1]/*[1]"};
        ...
        public void btnPesquisaPessoaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='pgPesquisa']/*[2]"};
            ...
            {
                selectors = new string[] {@"//*[@label='main']/*[1]/*[3]/*[1]/*[1]"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='pgCadastro']/*[1]/*[6]"};
            ...
            {
                selectors = new string[] {@"//*[@label='main']/*[6]"};
        ...
        public void btnOKSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/buttonPanel']/*[2]"};
            ...
            {
                selectors = new string[] {@"//*[@label='index.html']/*[1]/*[2]/*[1]/*[3]/*[2]/*[1]"};
