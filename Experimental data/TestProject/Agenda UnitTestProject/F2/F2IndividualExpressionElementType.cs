...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Agenda", ProjectConfig.OutputDeviceID, "F2", 7,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnPesquisaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@content-desc='Pesquisa']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeLink[@label='Pesquisa']"};
        ...
        public void btnInserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.EditText[@text='Pesquisa ']"};
        ...
        public void btnPesquisaPessoaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.view.View[@resource-id='btnPesquisar']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeStaticText[@label='search']"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Button[@content-desc='delete   EXCLUIR ']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeButton[@label='delete   EXCLUIR']"};
        ...
        public void btnOKSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*/android.widget.Button[@text='OK']"};
            ...
            {
                selectors = new string[] {@"//*/XCUIElementTypeButton[@label='OK']"};
