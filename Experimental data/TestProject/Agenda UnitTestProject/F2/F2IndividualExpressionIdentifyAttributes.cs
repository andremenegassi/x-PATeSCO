...
namespace UnitTestProject.F2
{
    ...
    public class F2IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Agenda", ProjectConfig.OutputDeviceID, "F2", 7,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnPesquisaSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Pesquisa']"};
        ...
        public void btnInserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='txtPesquisa']"};
        ...
        public void btnPesquisaPessoaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='btnPesquisar']"};
        ...
        public void btnEditarSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='edit']"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='btnExcluir']"};
            ...
            {
                selectors = new string[] {@"//*[@name='delete   EXCLUIR']"};
        ...
        public void btnOKSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/button1']"};
