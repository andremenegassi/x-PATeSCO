...
namespace UnitTestProject.F2
{
    ...
    public class F2CombinedExpressionsMultiLocator
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("Agenda", ProjectConfig.OutputDeviceID, "F2", 7,"CombinedExpressionsMultiLocator", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void btnPesquisaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View[2]/android.view.View[3]", @"", @"//*[@content-desc='Pesquisa' or @label='Pesquisa']", @"//*/android.view.View[@content-desc='Pesquisa']", @"//*[@content-desc='agenda']/*[1]/*[1]/*[2]/*[2]/*[3]", @"//*[@content-desc='agenda']//*[@content-desc='Pesquisa']"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeLink[3]", @"//*[@name='Pesquisa']", @"//*[@content-desc='Pesquisa' or @label='Pesquisa']", @"//*/XCUIElementTypeLink[@label='Pesquisa']", @"//*[@label='navigation']/*[3]", @"//*[@label='navigation']//*[@label='Pesquisa']"};
        ...
        public void btnInserirPesquisaSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.EditText", @"//*[@resource-id='txtPesquisa']", @"//*[@text='Pesquisa ']", @"//*/android.widget.EditText[@text='Pesquisa ']", @"//*[@resource-id='pgPesquisa']/*[1]/*[1]", @"//*[@resource-id='pgPesquisa']//*[@text='Pesquisa ']"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeTextField", @"", @"//*[@text='Pesquisa ']", @"", @"//*[@label='main']/*[1]/*[1]", @"//*[@label='main']//*[]"};
        ...
        public void btnPesquisaPessoaSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[2]", @"//*[@resource-id='btnPesquisar']", @"//*[@label='search']", @"//*/android.view.View[@resource-id='btnPesquisar']", @"//*[@resource-id='pgPesquisa']/*[2]", @"//*[@resource-id='pgPesquisa']//*[@resource-id='btnPesquisar']"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeStaticText", @"//*[@name='search']", @"//*[@label='search']", @"//*/XCUIElementTypeStaticText[@label='search']", @"//*[@label='main']/*[1]/*[3]/*[1]/*[1]", @"//*[@label='main']//*[@label='search']"};
        ...
        public void btnEditarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[3]/android.view.View[2]/android.view.View[2]", @"", @"//*[@content-desc='edit' or @label='edit']", @"//*/android.view.View[@content-desc='edit']", @"//*[@resource-id='listResultados']/*[2]/*[3]", @"//*[@resource-id='listResultados']//*[@content-desc='edit']"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View[3]/android.view.View[2]/android.view.View[2]";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeLink", @"//*[@name='edit']", @"//*[@content-desc='edit' or @label='edit']", @"//*/XCUIElementTypeLink[@label='edit']", @"//*[@label='main']/*[5]", @"//*[@label='main']//*[@label='edit']"};
        ...
        public void btnExcluirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.view.View/android.view.View/android.widget.Button", @"//*[@resource-id='btnExcluir']", @"//*[@content-desc='delete   EXCLUIR ' or @label='delete   EXCLUIR']", @"//*/android.widget.Button[@content-desc='delete   EXCLUIR ']", @"//*[@resource-id='pgCadastro']/*[1]/*[6]", @"//*[@resource-id='pgCadastro']//*[@content-desc='delete   EXCLUIR ']"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeWindow/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeButton", @"//*[@name='delete   EXCLUIR']", @"//*[@content-desc='delete   EXCLUIR ' or @label='delete   EXCLUIR']", @"//*/XCUIElementTypeButton[@label='delete   EXCLUIR']", @"//*[@label='main']/*[6]", @"//*[@label='main']//*[@label='delete   EXCLUIR']"};
        ...
        public void btnOKSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.Button[2]", @"//*[@resource-id='android:id/button1']", @"//*[@text='OK' or @label='OK']", @"//*/android.widget.Button[@text='OK']", @"//*[@resource-id='android:id/buttonPanel']/*[2]", @"//*[@resource-id='android:id/buttonPanel']//*[@text='OK']"};
            ...
            {
                selectors = new string[] {@"XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeAlert/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeCollectionView/XCUIElementTypeCell[2]/XCUIElementTypeButton", @"//*[@name='OK']", @"//*[@text='OK' or @label='OK']", @"//*/XCUIElementTypeButton[@label='OK']", @"//*[@label='index.html']/*[1]/*[2]/*[1]/*[3]/*[2]/*[1]", @"//*[@label='index.html']//*[@label='OK']"};
