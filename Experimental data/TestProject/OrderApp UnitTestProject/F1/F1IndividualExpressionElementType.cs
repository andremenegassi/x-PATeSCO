...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionElementType
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("PedidoApp", ProjectConfig.OutputDeviceID, "F1", 7,"IndividualExpressionElementType", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirnomeSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*/UIATextField[@value='Seu nome']"};
        ...
        public void inserirtelSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*/UIATextField[@value='Telefone']"};
        ...
        public void inserirendSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*/UIATextField[@value='Endereço']"};
