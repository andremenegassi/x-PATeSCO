...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionAncestorAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("PedidoApp", ProjectConfig.OutputDeviceID, "F1", 7,"IndividualExpressionAncestorAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selboloSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='De Brigadeiro apenas R$ 24']"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"//*[@label='De Brigadeiro apenas R$ 24']//*[@label='De Brigadeiro']"};
        ...
        public void btnpedirSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='Pedir esse bolo agora ']"};
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@label='Pedir esse bolo agora']"};
        ...
        public void inserirnomeSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@value='Seu nome']"};
        ...
        public void inserirtelSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@value='Telefone']"};
        ...
        public void inserirendSendKeys_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@value='Endereço']"};
        ...
        public void btnconfirmarSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='Confirmar Pedido! ']"};
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@label='Confirmar Pedido!']"};
        ...
        public void btnokSendClick_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"//*[@resource-id='android:id/content']//*[@content-desc='OK ']"};
            ...
            {
                selectors = new string[] {@"//*[@label='pedidoapp']//*[@label='OK']"};
