...
namespace UnitTestProject.F1
{
    ...
    public class F1IndividualExpressionIdentifyAttributes
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("PedidoApp", ProjectConfig.OutputDeviceID, "F1", 7,"IndividualExpressionIdentifyAttributes", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void selboloSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='De Brigadeiro']"};
        ...
        public void btnpedirSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Pedir esse bolo agora']"};
        ...
        public void btnconfirmarSendClick_Test()
        {
            ...
            {
                selectors = new string[] {@"//*[@name='Confirmar Pedido!']"};
