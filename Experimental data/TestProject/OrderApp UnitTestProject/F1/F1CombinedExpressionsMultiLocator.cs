...
namespace UnitTestProject.F1
{
    ...
    public class F1CombinedExpressionsMultiLocator
    {
        ...
        public void TestMethodMain()
        {
            ...
            Exec.Create("PedidoApp", ProjectConfig.OutputDeviceID, "F1", 7,"CombinedExpressionsMultiLocator", ProjectConfig.OutputPath);
            Exec.Instance.Start();
        ...
        public void inserirnomeSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[2]/android.widget.EditText", @"", @"//*[@value='Seu nome']", @"", @"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[3]/*[1]/*[1]/*[1]/*[2]/*[2]/*[1]", @"//*[@resource-id='android:id/content']//*[]"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[2]/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView[2]/UIAWebView/UIATextField", @"", @"//*[@value='Seu nome']", @"//*/UIATextField[@value='Seu nome']", @"//*[@label='pedidoapp']/*[1]/*[2]/*[1]/*[6]", @"//*[@label='pedidoapp']//*[@value='Seu nome']"};
        ...
        public void inserirtelSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.widget.EditText", @"", @"//*[@value='Telefone']", @"", @"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[3]/*[1]/*[1]/*[1]/*[2]/*[3]/*[1]", @"//*[@resource-id='android:id/content']//*[]"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[3]/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView[2]/UIAWebView/UIATextField[2]", @"", @"//*[@value='Telefone']", @"//*/UIATextField[@value='Telefone']", @"//*[@label='pedidoapp']/*[1]/*[2]/*[1]/*[7]", @"//*[@label='pedidoapp']//*[@value='Telefone']"};
        ...
        public void inserirendSendKeys_Test()
        {
            ...
            if (ProjectConfig.PlataformName == "Android")
            {
                selectors = new string[] {@"hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[4]/android.widget.EditText", @"", @"//*[@value='Endereço']", @"", @"//*[@resource-id='android:id/content']/*[1]/*[1]/*[1]/*[3]/*[1]/*[1]/*[1]/*[2]/*[4]/*[1]", @"//*[@resource-id='android:id/content']//*[]"};
                contingencyXPathSelector = "hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[3]/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View[4]/android.widget.EditText";
            }
            else if (ProjectConfig.PlataformName == "iOS")
            {
                selectors = new string[] {@"AppiumAUT/UIAApplication/UIAWindow/UIAScrollView[2]/UIAWebView/UIATextField[3]", @"", @"//*[@value='Endereço']", @"//*/UIATextField[@value='Endereço']", @"//*[@label='pedidoapp']/*[1]/*[2]/*[1]/*[8]", @"//*[@label='pedidoapp']//*[@value='Endereço']"};
